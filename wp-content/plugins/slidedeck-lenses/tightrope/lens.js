(function($){
    SlideDeckLens['tightrope'] = function(slidedeck){
    ...
    $(document).ready(function(){
        $('.lens-tightrope .slidedeck').each(function(){
            if(typeof($.data(this, 'lens-tightrope')) == 'undefined' || $.data(this, 'lens-tightrope') == null){
                $.data(this, 'lens-tightrope', new SlideDeckLens['tightrope'](this));
            }
        });
    });
})(jQuery);