       ...
       <div class="inner">
          ...
          <table id="widget-table">
            <tr>
			  ...
			  <div class="dialog">
				 <div class="content">
					<div class="t"></div><?php if ( function_exists('dynamic_sidebar') && dynamic_sidebar(__('Home Widgets Middle','theme707')) ) : endif; ?><a href="/blog/feed/" class="btnBlue follow">Follow</a></div>
